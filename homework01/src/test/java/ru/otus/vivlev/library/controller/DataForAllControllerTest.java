...
public class DataForAllControllerTest {
    ...
    static {
        urlsForUser.put("/api/v1/book", Map.of("get", status().isOk(), "post", status().isCreated()));
        urlsForAdmin.put("/api/v1/book", Map.of("get", status().isOk(), "post", status().isCreated()));
        ...
        urlsForUser.put("/api/v1/author", Map.of("get", status().isOk(), "post", status().isCreated()));
        urlsForAdmin.put("/api/v1/author", Map.of("get", status().isOk(), "post", status().isCreated()));
        urlsForUser.put("/api/v1/author/3", Map.of("delete", status().isNoContent()));
        ...
        urlsForUser.put("/api/v1/genre", Map.of("get", status().isOk(), "post", status().isCreated()));
        urlsForAdmin.put("/api/v1/genre", Map.of("get", status().isOk(), "post", status().isCreated()));
        urlsForUser.put("/api/v1/genre/3", Map.of("delete", status().isNoContent()));
        ...
        urlsForUser.put("/api/v1/comment", Map.of("post", status().isCreated()));
        urlsForAdmin.put("/api/v1/comment", Map.of("post", status().isCreated()));
